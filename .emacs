...
(setq my-package-list '(clang-format cmake-mode company company-irony company-irony-c-headers
				     company-jedi company-web dictcc diff-hl dash ein epc ggtags
